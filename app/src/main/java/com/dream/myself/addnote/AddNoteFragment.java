...
public class AddNoteFragment extends Fragment implements AddNoteContract.View {
    ...
    private AddNoteContract.UserActionsListener mPresenter;
...
//        mPresenter = new AddNotePresenter(Injection.provideNotesRepository(), this,
//                Injection.provideImageFile());
    ...
    @Override
    public void setPresenter(AddNoteContract.UserActionsListener presenter) {
